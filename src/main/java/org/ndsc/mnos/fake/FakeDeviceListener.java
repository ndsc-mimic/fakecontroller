 ...
 */
public class FakeDeviceListener implements OpenFlowSwitchListener, OpenFlowMessageListener, PacketListener {
    ...
    public void handleIncomingMessage(Dpid dpid, OFMessage msg) {
        ...
        switch (msg.getType()) {
            case PACKET_IN:
                shimController.sendOpenFlowMessageToCore(msg, MimicLayer.getXId(), dpid.value(), 0);
                break;
            case FLOW_REMOVED:
