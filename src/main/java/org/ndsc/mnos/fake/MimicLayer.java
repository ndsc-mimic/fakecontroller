...
public class MimicLayer {
    ...
    private FakeDeviceListener ofDeviceListener;
    ...
    public void activate(ComponentContext context) {
        ...
        //ShimController
        FakeController shimLayer = new FakeController(coreConnector, controller);
        coreConnector.RegisterCoreListener(shimLayer);

        //OFDevice initialization
        ofDeviceListener = new FakeDeviceListener(controller, shimLayer);
